...
class Hotel(models.Model):
    """Entité centrale du domaine hôtelier."""
    ...
    images = models.JSONField(default=list, blank=True)  # liste d'URLs
    price_per_night = models.DecimalField(
        max_digits=10, decimal_places=2, default=Decimal('0.00')
    )
    amenities = models.JSONField(default=list, blank=True)  # ex: ["Wi-Fi", "Piscine"]
...
class Room(models.Model):
    """Chambre appartenant à un hôtel."""
    ...
    type = models.CharField(max_length=100)  # ex: "Double", "Suite"
    description = models.TextField(blank=True)
...
class PricingRule(models.Model):
    """Règle tarifaire appliquée à une chambre (saison, jours, etc.)."""
...
class Transaction(models.Model):
    """Transaction générée par une réservation."""
...
class Promotion(models.Model):
    """Promotion (code promo) applicable aux réservations."""
...
class Review(models.Model):
    """Avis laissé par un client sur un hôtel."""
    ...
    photos = models.JSONField(default=list, blank=True)  # URLs
